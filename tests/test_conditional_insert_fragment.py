...
def test_conditional_insert_fragment():
    ...
    initial_fragment_gateways = count_exclusive_gateways_in(absolute_input_path)

    branch_insert_process(absolute_input_path, absolute_input2_path, 'flow11', 'flow13', absolute_output_path, True)
